        ...
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                ...
                <div class="p-6 border-b border-gray-100">
                    ...
                    <p class="text-xs text-gray-500">Silakan isi informasi kategori baru di bawah ini.</p>
                </div>
                ...
                <form action="{{ route('categories.store') }}" method="POST" class="p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="name" id="name" value="{{ old('name') }}" required placeholder="Contoh: Alat Tulis Kantor, Elektronik" class="w-full px-4 py-2.5 bg-gray-50 border-gray-200 focus:border-accent-500 focus:ring focus:ring-accent-500/20 rounded-xl text-sm transition-all duration-150 @error('name') border-rose-500 focus:border-rose-500 focus:ring-rose-200 @enderror">
                        @error('name')
